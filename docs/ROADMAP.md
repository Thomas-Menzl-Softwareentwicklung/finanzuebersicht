...
| [#243](https://github.com/Thomas-Menzl-Softwareentwicklung/finanzuebersicht/issues/243) | CloudKit-Sync zwischen Geräten — MVP + Drei-Geräte-QA (iPhone → iPad → iMac) | XL ✅ |
