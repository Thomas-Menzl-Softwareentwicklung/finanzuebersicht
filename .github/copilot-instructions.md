...
- Active architecture milestone: **v1.20** (`docs/ROADMAP.md`) — before Milestone 22 features and v2.0 (encryption / multi-currency). Next: CategoriesViewModel split (#294), then App-Events (#271).
